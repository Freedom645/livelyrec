...
SELECT_ROI: dict[str, Box] = {
    ...
    # UPPER マークは譜面ごとに固定で「右側」か「左側」に表示される
    # （規則性不明、実機サンプルで両側パターン確認、2026-05-31）。
    # 認識器は両方の ROI でテンプレマッチを試行し、どちらかで合致したら is_upper。
    "upper_mark":       (371, 307, 501, 335),       # 右側 (130×28)
    "upper_mark_left":  (117, 307, 244, 334),       # 左側 (127×27)
